...
int main(int argc, char* argv[]) {
  cxxargs::Arguments args("telescope-union", "Usage:...");
  try {
  ...
  ReadUnionAlignments(args.value<std::string>('1'), ecs, args.value<uint32_t>("n-refs"));
  ReadUnionAlignments(args.value<std::string>('2'), ecs, args.value<uint32_t>("n-refs"));
